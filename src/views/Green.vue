        ...
        <div class="chart-main clearfix">
            <div class="chart-left">
                ...
                <div class="year-plane event-title">
                    <ul>
                        <li @click="showPopGrain"><span class="year-plane-label">粮食生产功能区</span><span class="year-plane-data"><em>{{planData.lsgn}}</em>万亩</span></li>
                        <li @click="showPopGrain"><span class="year-plane-label">蔬菜生产保护区</span><span class="year-plane-data"><em>{{planData.scbh}}</em>万亩</span></li>
                        <li @click="showPopGrain"><span class="year-plane-label">特色农产品优势区</span><span class="year-plane-data"><em>{{planData.tsys}}</em>万亩</span></li>
                    </ul>
                </div>
                ...
                <div class="chart-land-box">
                    <div class="output-unit"><div class="chart-unit">(万亩)</div></div>
            ...
            <div class="chart-middle">
                                ...
                                <div class="map-chart-line">
                                    <ul>
                                        <li  :class="{active:mapIndex==index}" @click='changeMap(index)' v-for="(item,index) in mapTable" :key=index>
                                            <span class="chart-v-icon"><img :src="require('@/assets/images/g-c-icon'+(index+1)+'.png')" alt=""></span>
                ...
                <div class="probability">
                    <div class="output-unit"><div class="chart-unit">(%)</div></div>
            ...
            <div class="chart-right">
                ...
                <div class="attestation-chart">
                    <div class="output-unit"><div class="chart-unit">（%）</div></div>
                    <line-chart-dobble ref='attestGetData' :width='attestWidth' :height='attestHeight'></line-chart-dobble>
                </div>
                <div class="chart-left-title space-title event-title" @click="showCertifiedPage">
                    绿色认证经营主体 <div class="inner-year">(2019.6)</div>
                </div>
                ...
                <div class="chart-left-title space-three">
                    两品一标  <div class="inner-year">(2019.6)</div>
                </div>
